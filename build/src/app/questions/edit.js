angular.module('ngQuestionnaires.questions').controller('QuestionNewCtrl', [
  '$scope',
  '$state',
  '$stateParams',
  'questionFactory',
  function ($scope, $state, $stateParams, questionFactory) {
    ...
    $scope.save = function () {
      questionFactory.add(angular.copy($scope.question)).then(function () {
  ...
  function ($scope, $state, $stateParams, questionFactory) {
    ...
    $scope.update = function () {
      questionFactory.update($stateParams.id, $scope.question).then(function () {
