angular.module('ngQuestionnaires.responses').controller('ResponseNewCtrl', [
  '$scope',
  '$state',
  '$stateParams',
  ...
  function ($scope, $state, $stateParams, questionnaireFactory, responseFactory) {
    ...
    $scope.submit = function () {
      ...
      responseFactory.add({
        ...
        $scope.addSuccessAlert('Response from ' + $scope.respondent + ' on ' + $scope.questionnaire.title + ' saved successfully');
