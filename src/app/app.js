...
angular.module('ngQuestionnaires', [
  ...
  .controller('seedCtrl',
    ['$scope', '$q', 'questionnaireFactory', 'questionFactory', 'responseFactory', 'underscore',
      function ($scope, $q, questionnaireFactory, questionFactory, responseFactory, underscore) {
